...
*Click on a header to sort the table*  -- [Abbreviations](#abbreviations) & terms below the table.
...
DF2 <- data.frame(namelink, descrip, lang, notes, status)
names(DF2) <- c("name", "description", "language", "notes", "status")
