...
*The date is found by automatic checking of sites with valid links.  Commits and issues are only checked for Github sites. Web site updates are found using a simple search for common date formats and may be inaccurate. Keep in mind the most recent activity may be on any branch in a repo, and may be newer than any official releases.*
